...
export default function MyBookingsPage() {
    ...
    useEffect(() => {
        ...
        if (token && user) {
            ...
            try {
                ...
                setUserId(parsedUser._id); // Assuming the user object has an _id property
            } catch (e) {
    ...
    async function loadBookings() {
        ...
        try {
            ...
            // The backend now filters, but we can double-check here
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-sm text-gray-600">
                                                ...
                                                {/* We don't need to show the user's own name on their own bookings page */}
                                            </div>
                                        </div>
                                        <button
